# coding=utf-8
#
# copy from agents/model_settings.py
#
...
class ModelSettings:
    ...
    def from_dict(cls, data: dict[str, Any]) -> ModelSettings:
        ...
        Args:
            data: A dictionary containing model settings parameters.
        
        Returns:
            A new ModelSettings instance with values from the dictionary.
        """
        ...
        if "tool_choice" in filtered_data and isinstance(filtered_data["tool_choice"], dict):
            # Check if it's an MCPToolChoice
            if "server_label" in filtered_data["tool_choice"] and "name" in filtered_data["tool_choice"]:
                filtered_data["tool_choice"] = MCPToolChoice(**filtered_data["tool_choice"])
